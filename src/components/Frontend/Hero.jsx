...
export default function Hero() {
  return (
    <div className="bg-blue-950 min-h-screen">
      {" "}
      <div className="relative max-w-6xl mx-auto  pb-[110px] pt-[50px] dark:bg-dark lg:pt-[150px]">
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 lg:w-5/12">
              <div className="hero-content">
                <h1 className="mb-5 text-4xl font-bold !leading-[1.208] text-dark dark:text-gray-50 sm:text-[42px] lg:text-[40px] xl:text-5xl">
                ...
                <ul className="flex flex-wrap items-center mt-6">
                  ...
                  <li>
                    <a
                      href="/#"
                      className="inline-flex items-center justify-center px-5 py-3 text-center text-base font-medium text-[#464646] hover:text-primary dark:text-gray-50"
                    >
                      <span className="mr-2">
                        <svg
                          width="24"
